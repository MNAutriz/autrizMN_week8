...
// Utility functions to convert celsius to fahrenheit and vice versa
const toCelsius = (f) => {
    return (f - 32) * 5 / 9;
}
...
export default function TempConverter() {
    ...
    // When user types in the input field for the fahrenheit, we'll set the value of fahrenheit to the user input, then convert the value to Celsius, which will reflect in the other field
